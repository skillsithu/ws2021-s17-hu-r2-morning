...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2020. Már 07. 10:19
...
CREATE TABLE `flats` (
  ...
  `orientation` varchar(2) COLLATE utf8_bin NOT NULL,
...
--
ALTER TABLE `flats`
  ADD CONSTRAINT `b_id_fk` FOREIGN KEY (`building_id`) REFERENCES `buildings` (`id`);
COMMIT;
