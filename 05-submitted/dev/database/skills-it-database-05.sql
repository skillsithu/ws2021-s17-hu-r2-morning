...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2020. Már 07. 12:36
...
--
-- Tábla szerkezet ehhez a táblához `mytable`
--
...
--
-- A tábla adatainak kiíratása `mytable`
--

INSERT INTO `mytable` (`id`, `building_id`, `ref`, `floor`, `rooms`, `orientation`, `net_area`, `balcony_area`, `price`, `sold`) VALUES
